                      ...
                      <div key={lesson.lesson_id} className="border border-border rounded-lg p-4 hover:bg-accent/5 transition-colors">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex flex-col items-end gap-2">
                            <div className={`px-3 py-1.5 rounded-lg border flex items-center gap-2 ${getStatusColor(lesson.status)}`}>
                              {getStatusIcon(lesson.status)}
                              <span className="text-sm font-medium">{lesson.status_display}</span>
                            </div>
