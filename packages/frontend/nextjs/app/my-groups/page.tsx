...
import { Bell, SignOut, User, MapPin, Clock, Calendar, Plus } from "@phosphor-icons/react"
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Ваши записанные занятия</h1>
            ...
            >
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-xs text-muted-foreground mb-0.5">Расписание</div>
                    <div className="font-medium text-foreground">{group.schedule}</div>
                  </div>
                </div>
